...
function TControllerPessoa(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TControllerPessoa",connectionInfo);
  ...
  /*
   * @param pIDPessoa [in] - Type on server: Int64
   * @return result - Type on server: TJSONObject
   */
  this.getPessoa = function(pIDPessoa) {
    var returnObject = this.executor.executeMethod('getPessoa', "GET", [pIDPessoa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.pIDPessoa = pIDPessoa;
        resultObject.result = resultArray[0];
        if (returnObject.cacheId != null && returnObject.cmdIndex != null) {
          resultObject._cacheId = returnObject.cacheId;
          resultObject._cmdIndex = returnObject.cmdIndex;
  ...
  this.getPessoa_URL = function(pIDPessoa) {
    return this.executor.getMethodURL("getPessoa", "GET", [pIDPessoa], arguments[1])[0];
  };
   ...
   * @return result - Type on server: TJSONObject
   */
  this.updatePessoa = function(pIDPessoa) {
    var returnObject = this.executor.executeMethod('Pessoa', "POST", [pIDPessoa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.updatePessoa_URL = function(pIDPessoa) {
    return this.executor.getMethodURL("Pessoa", "POST", [pIDPessoa], arguments[1])[0];
  };

  /*
   * @param obj [in] - Type on server: TJSONValue
   * @return result - Type on server: Boolean
   */
  this.acceptPessoa = function(obj) {
    var returnObject = this.executor.executeMethod('Pessoa', "PUT", [obj], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
   ...
   * @return result - Type on server: TJSONObject
   */
  this.cancelPessoa = function(pIDPessoa) {
    var returnObject = this.executor.executeMethod('Pessoa', "DELETE", [pIDPessoa], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.cancelPessoa_URL = function(pIDPessoa) {
    return this.executor.getMethodURL("Pessoa", "DELETE", [pIDPessoa], arguments[1])[0];
  };

  this.AfterConstruction = function() {
    this.executor.executeMethod('AfterConstruction', "GET", [], arguments[0], false, arguments[1], arguments[2]);
  };

  this.AfterConstruction_URL = function() {
    return this.executor.getMethodURL("AfterConstruction", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TControllerPessoa": ["EchoString","ReverseString","getPessoa","updatePessoa","acceptPessoa","cancelPessoa","AfterConstruction"]
};
